...
public class MockServerExpectations implements PluginExpectationInitializer {
    ...
    private void setFindEntitiesByQualifiedName(MockServerClient mockServerClient) {
        ...
        setSearchAndResponse(mockServerClient, caseName, "results_admin.json",
                "{\"types\":[\"user\"],\"properties\":[\"business_address\",\"courtesy_title\",\"created_by\",\"created_on\",\"email_address\",\"fax_number\",\"full_name\",\"given_name\",\"home_phone_number\",\"instant_message_id\",\"job_title\",\"location\",\"mobile_phone_number\",\"modified_by\",\"modified_on\",\"office_phone_number\",\"organization\",\"pager_number\",\"principal_id\",\"surname\"],\"pageSize\":100,\"where\":{\"conditions\":[{\"conditions\":[{\"property\":\"email_address\",\"operator\":\"like %{0}\",\"value\":\"IIS\"},{\"conditions\":[{\"property\":\"courtesy_title\",\"operator\":\"like {0}%\",\"value\":\"IIS\"},{\"property\":\"given_name\",\"operator\":\"like {0}%\",\"value\":\"IIS\"},{\"property\":\"surname\",\"operator\":\"like {0}%\",\"value\":\"IIS\"}],\"operator\":\"or\"}],\"operator\":\"or\"}],\"operator\":\"and\"},\"sorts\":[{\"property\":\"_id\",\"ascending\":true}]}");
