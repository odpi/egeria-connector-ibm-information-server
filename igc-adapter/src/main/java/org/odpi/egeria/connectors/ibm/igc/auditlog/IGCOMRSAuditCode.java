...
public enum IGCOMRSAuditCode implements AuditLogMessageSet {
    ...
    EVENT_MAPPER_STARTING("OMRS-IGC-REPOSITORY-0009",
            OMRSAuditLogRecordSeverity.INFO,
            "The IBM Information Governance Catalog event mapper is starting up",
            "The local server has requested startup of an IBM Information Governance Catalog event mapper.",
            "No action is required.  This is part of the normal operation of the service."),
