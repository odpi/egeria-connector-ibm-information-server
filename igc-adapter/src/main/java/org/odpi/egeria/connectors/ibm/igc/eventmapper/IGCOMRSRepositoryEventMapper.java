...
public class IGCOMRSRepositoryEventMapper extends OMRSRepositoryEventMapperBase
    ...
    private EntityDetail getEntityDetailForAssetWithRID(Reference asset, String rid) {
        ...
        try {
            detail = igcomrsMetadataCollection.getEntityDetail(localServerUserId, igcomrsMetadataCollection.getGuidForRid(rid), asset);
    ...
    private void sendPurgedRelationship(RelationshipMapping relationshipMapping,
        ...
        if (proxyOne != null && proxyTwo != null) {
            try {
                ...
                OMRSStub stubOne = igcomrsMetadataCollection.getOMRSStubForAsset(proxyOne);
                OMRSStub stubTwo = igcomrsMetadataCollection.getOMRSStubForAsset(proxyTwo);
