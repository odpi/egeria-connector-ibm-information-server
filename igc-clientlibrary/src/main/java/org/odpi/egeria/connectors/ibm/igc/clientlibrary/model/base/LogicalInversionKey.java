 ...
 */
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME, include=JsonTypeInfo.As.EXISTING_PROPERTY, property="_type", visible=true, defaultImpl=LogicalInversionKey.class)
...
public class LogicalInversionKey extends Reference {
    ...
    /**
     * Retrieve the {@code defined_on_entity_attributes} property (displayed as '{@literal Referenced by Entity Attributes}') of the object.
    ...
    /**
     * Set the {@code defined_on_entity_attributes} property (displayed as {@code Referenced by Entity Attributes}) of the object.
