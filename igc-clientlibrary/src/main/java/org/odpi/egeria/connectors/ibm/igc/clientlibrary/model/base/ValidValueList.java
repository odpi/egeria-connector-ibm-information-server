...
public class ValidValueList extends Reference {
    ...
    /**
     * Retrieve the {@code valid_values} property (displayed as '{@literal Valid Values}') of the object.
     * @return {@code ItemList<DataItemValue>}
     */
    @JsonProperty("valid_values")
    public ItemList<DataItemValue> getValidValues() { return this.validValues; }

    /**
     * Set the {@code valid_values} property (displayed as {@code Valid Values}) of the object.
     * @param validValues the value to set
     */
    @JsonProperty("valid_values")
    public void setValidValues(ItemList<DataItemValue> validValues) { this.validValues = validValues; }
