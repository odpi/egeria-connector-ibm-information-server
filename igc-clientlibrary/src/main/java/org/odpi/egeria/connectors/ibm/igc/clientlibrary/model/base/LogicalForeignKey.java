 ...
 */
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME, include=JsonTypeInfo.As.EXISTING_PROPERTY, property="_type", visible=true, defaultImpl=LogicalForeignKey.class)
...
public class LogicalForeignKey extends Reference {
    ...
    @JsonProperty("child_entity_attributes")
    protected ItemList<EntityAttribute> childEntityAttributes;
    ...
    @JsonProperty("referenced_by_entity_attributes")
    protected ItemList<EntityAttribute> referencedByEntityAttributes;

    @JsonProperty("short_description")
    protected String shortDescription;

    /**
     * Retrieve the {@code child_entity_attributes} property (displayed as '{@literal Child Entity Attributes}') of the object.
     * @return {@code ItemList<EntityAttribute>}
     */
    @JsonProperty("child_entity_attributes")
    public ItemList<EntityAttribute> getChildEntityAttributes() { return this.childEntityAttributes; }

    /**
     * Set the {@code child_entity_attributes} property (displayed as {@code Child Entity Attributes}) of the object.
     * @param childEntityAttributes the value to set
     */
    @JsonProperty("child_entity_attributes")
    public void setChildEntityAttributes(ItemList<EntityAttribute> childEntityAttributes) { this.childEntityAttributes = childEntityAttributes; }
    ...
    /**
     * Retrieve the {@code referenced_by_entity_attributes} property (displayed as '{@literal Parent Entity Attribute}') of the object.
     * @return {@code ItemList<EntityAttribute>}
     */
    @JsonProperty("referenced_by_entity_attributes")
    public ItemList<EntityAttribute> getReferencedByEntityAttributes() { return this.referencedByEntityAttributes; }

    /**
     * Set the {@code referenced_by_entity_attributes} property (displayed as {@code Parent Entity Attribute}) of the object.
     * @param referencedByEntityAttributes the value to set
     */
    @JsonProperty("referenced_by_entity_attributes")
    public void setReferencedByEntityAttributes(ItemList<EntityAttribute> referencedByEntityAttributes) { this.referencedByEntityAttributes = referencedByEntityAttributes; }
