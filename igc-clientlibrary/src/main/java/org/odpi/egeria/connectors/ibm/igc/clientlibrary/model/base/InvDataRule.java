 ...
 */
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME, include=JsonTypeInfo.As.EXISTING_PROPERTY, property="_type", visible=true, defaultImpl=InvDataRule.class)
...
public class InvDataRule extends Reference {
    ...
    protected InvDataRuleDefinition dataRuleDefinitions;
     ...
     * @return {@code InvDataRuleDefinition}
     */
    @JsonProperty("data_rule_definitions")
    public InvDataRuleDefinition getDataRuleDefinitions() { return this.dataRuleDefinitions; }
     ...
     */
    @JsonProperty("data_rule_definitions")
    public void setDataRuleDefinitions(InvDataRuleDefinition dataRuleDefinitions) { this.dataRuleDefinitions = dataRuleDefinitions; }
