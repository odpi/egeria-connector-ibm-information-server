 ...
 */
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME, include=JsonTypeInfo.As.EXISTING_PROPERTY, property="_type", visible=true, defaultImpl=RootTuple.class)
...
public class RootTuple extends Reference {
    ...
    /**
     * Retrieve the {@code endpoint} property (displayed as '{@literal Endpoint}') of the object.
    ...
    /**
     * Set the {@code endpoint} property (displayed as {@code Endpoint}) of the object.
