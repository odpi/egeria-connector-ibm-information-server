 ...
 */
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME, include=JsonTypeInfo.As.EXISTING_PROPERTY, property="_type", visible=true, defaultImpl=OutParameter.class)
...
public class OutParameter extends InformationAsset {
     ...
     */
    @JsonProperty("stored_procedure")
    public ItemList<StoredProcedureDefinition> getStoredProcedure() { return this.storedProcedure; }
     ...
     */
    @JsonProperty("stored_procedure")
    public void setStoredProcedure(ItemList<StoredProcedureDefinition> storedProcedure) { this.storedProcedure = storedProcedure; }
