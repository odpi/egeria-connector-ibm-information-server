...
public class CdcMapping extends Reference {
    ...
    /**
     * Retrieve the {@code cdc_mapping_document} property (displayed as '{@literal CDC Mapping Document}') of the object.
     * @return {@code ItemList<CdcMappingDocument>}
     */
    @JsonProperty("cdc_mapping_document")
    public ItemList<CdcMappingDocument> getCdcMappingDocument() { return this.cdcMappingDocument; }

    /**
     * Set the {@code cdc_mapping_document} property (displayed as {@code CDC Mapping Document}) of the object.
     * @param cdcMappingDocument the value to set
     */
    @JsonProperty("cdc_mapping_document")
    public void setCdcMappingDocument(ItemList<CdcMappingDocument> cdcMappingDocument) { this.cdcMappingDocument = cdcMappingDocument; }
