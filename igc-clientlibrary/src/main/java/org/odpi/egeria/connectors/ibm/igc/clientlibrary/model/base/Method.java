 ...
 */
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME, include=JsonTypeInfo.As.EXISTING_PROPERTY, property="_type", visible=true, defaultImpl=Method.class)
@JsonAutoDetect(getterVisibility=PUBLIC_ONLY, setterVisibility=PUBLIC_ONLY, fieldVisibility=NONE)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown=true)
@JsonTypeName("method")
public class Method extends InformationAsset {
    ...
    protected ItemList<OutputValue> outputValues;
    ...
    /**
     * Retrieve the {@code input_parameters} property (displayed as '{@literal Input Parameters}') of the object.
     * @return {@code ItemList<InputParameter>}
     */
    @JsonProperty("input_parameters")
    public ItemList<InputParameter> getInputParameters() { return this.inputParameters; }

    /**
     * Set the {@code input_parameters} property (displayed as {@code Input Parameters}) of the object.
     ...
     */
    @JsonProperty("object_type")
    public ItemList<ObjectType> getObjectType() { return this.objectType; }

    /**
     * Set the {@code object_type} property (displayed as {@code Object Type}) of the object.
     * @param objectType the value to set
     */
    @JsonProperty("object_type")
    public void setObjectType(ItemList<ObjectType> objectType) { this.objectType = objectType; }

    /**
     * Retrieve the {@code output_values} property (displayed as '{@literal Output Values}') of the object.
     * @return {@code ItemList<OutputValue>}
     */
    @JsonProperty("output_values")
    public ItemList<OutputValue> getOutputValues() { return this.outputValues; }

    /**
     * Set the {@code output_values} property (displayed as {@code Output Values}) of the object.
     * @param outputValues the value to set
     */
    @JsonProperty("output_values")
    public void setOutputValues(ItemList<OutputValue> outputValues) { this.outputValues = outputValues; }
