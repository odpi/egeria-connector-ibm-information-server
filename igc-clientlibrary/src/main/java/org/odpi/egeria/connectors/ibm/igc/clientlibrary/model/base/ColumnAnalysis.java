 ...
 */
@JsonTypeInfo(use=JsonTypeInfo.Id.NAME, include=JsonTypeInfo.As.EXISTING_PROPERTY, property="_type", visible=true, defaultImpl=ColumnAnalysis.class)
...
public class ColumnAnalysis extends Reference {
    ...
    protected DatabaseColumn databaseColumn;
    ...
    /**
     * Retrieve the {@code database_column} property (displayed as '{@literal Database Column}') of the object.
     * @return {@code DatabaseColumn}
     */
    @JsonProperty("database_column")
    public DatabaseColumn getDatabaseColumn() { return this.databaseColumn; }

    /**
     * Set the {@code database_column} property (displayed as {@code Database Column}) of the object.
     * @param databaseColumn the value to set
     */
    @JsonProperty("database_column")
    public void setDatabaseColumn(DatabaseColumn databaseColumn) { this.databaseColumn = databaseColumn; }
