...
package org.odpi.egeria.connectors.ibm.igc.clientlibrary.model.generated.v11700;
...
public class DatabaseColumn extends Reference {
     ...
     */
    protected ArrayList<String> length;
    ...
    /** @see #length */ @JsonProperty("length")  public ArrayList<String> getLength() { return this.length; }
    /** @see #length */ @JsonProperty("length")  public void setLength(ArrayList<String> length) { this.length = length; }
