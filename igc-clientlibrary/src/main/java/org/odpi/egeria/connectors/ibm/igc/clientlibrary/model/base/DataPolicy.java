...
public class DataPolicy extends Reference {
    ...
    /**
     * Retrieve the {@code long_description} property (displayed as '{@literal Policy Text}') of the object.
     * @return {@code String}
     */
    @JsonProperty("long_description")
    ...
    /**
     * Set the {@code long_description} property (displayed as {@code Policy Text}) of the object.
    ...
    /**
     * Retrieve the {@code name} property (displayed as '{@literal Title}') of the object.
     * @return {@code String}
     */
    @JsonProperty("name")
    ...
    /**
     * Set the {@code name} property (displayed as {@code Title}) of the object.
