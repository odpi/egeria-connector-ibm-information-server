...
public class InvalidOutputColumn extends Error {

    @JacksonXmlProperty(isAttribute = true) private String executableRuleName;
    @JacksonXmlProperty(isAttribute = true) private String outputColumnName;
    ...
    public void setOutputColumnName(String outputColumnName) { this.outputColumnName = outputColumnName; }
