...
1. Download the latest IBM Information Server connector from: https://odpi.jfrog.io/odpi/egeria-snapshot-local/org/odpi/egeria/egeria-connector-ibm-information-server-package/1.6-SNAPSHOT/egeria-connector-ibm-information-server-package-1.6-SNAPSHOT-jar-with-dependencies.jar
