...
1. Download the latest IBM Information Server connector from: https://odpi.jfrog.io/odpi/egeria-snapshot-local/org/odpi/egeria/egeria-connector-ibm-information-server-package/2.0-SNAPSHOT/egeria-connector-ibm-information-server-package-2.0-SNAPSHOT-jar-with-dependencies.jar
...
- Release: https://odpi.jfrog.io/odpi/egeria-release-local/org/odpi/egeria/egeria-connector-ibm-information-server-package/1.8/egeria-connector-ibm-information-server-package-1.8-jar-with-dependencies.jar
- Snapshot: https://odpi.jfrog.io/odpi/egeria-snapshot-local/org/odpi/egeria/egeria-connector-ibm-information-server-package/2.0-SNAPSHOT/egeria-connector-ibm-information-server-package-2.0-SNAPSHOT-jar-with-dependencies.jar
