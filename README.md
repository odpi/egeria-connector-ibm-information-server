...
1. Download the latest IBM Information Server connector from: https://odpi.jfrog.io/odpi/egeria-snapshot-local/org/odpi/egeria/egeria-connector-ibm-information-server-package/2.3-SNAPSHOT/egeria-connector-ibm-information-server-package-2.3-SNAPSHOT-jar-with-dependencies.jar
1. Download the latest Egeria core from: https://odpi.jfrog.io/odpi/egeria-snapshot-local/org/odpi/egeria/server-chassis-spring/2.3-SNAPSHOT/server-chassis-spring-2.3-SNAPSHOT.jar
...
- Snapshot: https://odpi.jfrog.io/odpi/egeria-snapshot-local/org/odpi/egeria/egeria-connector-ibm-information-server-package/2.3-SNAPSHOT/egeria-connector-ibm-information-server-package-2.3-SNAPSHOT-jar-with-dependencies.jar
